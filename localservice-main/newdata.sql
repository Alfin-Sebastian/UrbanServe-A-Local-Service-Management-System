...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2025 at 07:27 PM
...
(1, 2, '5+ years of experience', 'Changanacherry', 'Dedicated and customer-focused service provider based in Changanacherry, Kerala. I aim to deliver quality services on time, with attention to detail and a friendly approach. My goal is to ensure every customer gets hassle-free, professional assistance for their everyday service needs.', 'uploads/id_proofs/id_proof_2_1754212638.png', 1, 'approved', 'sfgthfdraw', 'available', 0.00),
(2, 3, '3 years of experience', 'Kottayam', 'I am a dedicated service provider based in Kottayam, Kerala, committed to offering trustworthy and efficient solutions. My goal is to ensure customer satisfaction through honest work, attention to detail, and a friendly approach.', 'uploads/id_proofs/id_proof_3_1754269904.jpg', 1, 'approved', NULL, 'available', 0.00),
(3, 5, '4+ years of experience', 'Thrickodithanam', 'I am a dedicated service provider from Thrickodithanam, committed to offering fast, reliable, and affordable solutions. My focus is on customer satisfaction, timely response, and ensuring quality service in every job I take up.', 'uploads/id_proofs/id_proof_5_1754356696.png', 1, 'approved', NULL, 'available', 0.00);
...
(2, 'Wiring', 5, 'At kottayam', 500.00, 60, NULL, '2025-08-05 00:25:03'),
...
(1, 'Admin User', 'admin@urbanserve.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '9876543210', '123 Admin Street', 'Mumbai', 'Kerala', '686105', NULL, 1, '2025-08-03 08:53:47', '2025-09-16 16:07:46'),
(2, 'ALEX jj', 'alfinsebastian333@gmail.com', '$2y$10$xg9Fsf/v5bbvyziV.hNaEu6tLhVaEYO99fRwc2XfJbhT596OhEkYe', 'provider', '8078441117', '', 'Changanacherry', 'Kerala', '686105', 'uploads/profiles/688f25e04e819.jpg', 1, '2025-08-03 09:02:22', '2025-09-16 12:05:32'),
(3, 'Alan', 'alfinsebastian33@gmail.com', '$2y$10$IbjV8RQexFqiVRyDi.GEJe1v.HF5Gvjg62yduQXib9Zeqqdb9jFGS', 'provider', '9078441167', '', 'Kottayam', 'Kerala', '686106', 'uploads/profiles/68914fbbb8f9c.jpg', 1, '2025-08-04 01:09:00', '2025-09-16 13:10:08'),
...
(5, 'John', 'john1@gmail.com', '$2y$10$Xs/6vW5RdiXKMy6QrEZmkuLQEaSHs1sMskxq.rOWB7Vz9ZLI1BYFK', 'provider', '9806894567', '', 'Thrickodithanam', 'Kerala', '686105', 'uploads/profiles/68915cc2e9f65.jpeg', 1, '2025-08-05 01:15:52', '2025-09-16 12:47:18');
