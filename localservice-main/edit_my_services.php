...
// Get the service ID from URL parameter
    ...
    if ($_POST['action'] === 'delete') {
        ...
        if ($stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: provider_dashboard.php?message=Service deleted successfully&type=success");
                exit;
            } else {
...
// Fetch only the specific service to edit
$sql = "
    SELECT 
...
if ($service_result->num_rows === 0) {
    header("Location: provider_dashboard.php?message=Service not found or unauthorized&type=error");
    exit;
}
...
<head>
    ...
    <title>Edit Service | UrbanServe Provider</title>
    <style>
        :root {
            --primary: #f76d2b;
            --primary-dark: #e05b1a;
