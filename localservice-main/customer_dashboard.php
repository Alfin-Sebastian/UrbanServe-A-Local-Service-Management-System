...
// Fetch customer data - UPDATED TO INCLUDE profile_image
$customer_sql = "SELECT name, email, phone, address, city, state, pincode, created_at, profile_image FROM users WHERE id = ?";
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <!-- UPDATED: Use actual profile image if available, otherwise fallback to avatar -->
                <?php if (!empty($customer['profile_image'])): ?>
                    <img src="<?= htmlspecialchars($customer['profile_image']) ?>" 
